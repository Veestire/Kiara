...
class Slotmachine:
    ...
    def __init__(self):
        self.reels = [[], [], [], [], []]
        self.fruits = [
            Fruit('🍐', (12, 13, 10, 10, 12), (0, 1, 5, 20, 50)),
            Fruit('🍌', (8, 7, 9, 9, 8), (0, 2, 10, 50, 250)),
            Fruit('🍇', (5, 6, 6, 6, 5), (0, 10, 45, 200, 1250)),
            Fruit('🍉', (2, 1, 3, 2, 3), (0, 25, 150, 1000, 2500)),
            Fruit('🍰', (1, 1, 1, 1, 1), (0, 65, 250, 2500, 5000)),
