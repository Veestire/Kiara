...
extra_colors = [
    # ("Winter Breeze", 403584549847564304, 45),
    # ("Bronze", 399125560661377025, 45),
    # ("Twilight", 360765369180225556, 45),
    # ("Journey", 360792645389516811, 45),
    # ("Passion Pink", 360765505788968961, 60),
    # ("Blinding Soul", 360792991968788480, 60),
    ("Burning Passion", 360766053678055424, 60),
    ("Seductive Embrace", 383816911072395269, 60),
    # ("A Story Untold", 360785400798904331, 60),
    ("Cute Tea Party", 360791701025062913, 60),
    # ("Heaven's Dewdrop", 486441479183794176, 60),
    ("Vanilla Caramel", 511013041924735008, 60),
    ("Turquoise", 522959542238183446, 60),
    ("A Darkness Only Seen Within", 360788545759084554, 100),
    ("Spring Petal Dancing In The Mist", 403591076532846596, 100),
    ("Orchid Garden", 403583624558936065, 100),
    # ("Gaze Upon The Stars", 369825912813780993, 100),
    ("Walkin' on a Sunset", 383817936898490378, 100),
    # ("Falling Leaves", 488179302852984843, 100),
    # ("Dawn's Afterglow", 495602945644298253, 100),
    ("Pure Cum", 481575765469560835, 100),
    ("Snowfield", 511013042411143198, 100),
    ("Love is in the Air", 488198971840266251, 150),
    # ("Purest of Souls", 488195279045263403, 150),
    ("Nostalgic Navy", 495604244188233728, 150),
    ("Amethyst", 495601258309091345, 300),
    ("Crimson", 523662357289893889, 300),
    ("Lavender Amethyst", 523662812824731669, 500),
    # ("Embers", 408867902410719233, 500),
]
